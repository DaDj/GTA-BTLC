...
void CMotionBlurStreaks::RegisterStreak(unsigned int id, unsigned char red, unsigned char green, unsigned char blue, uint8 alpha, CVector leftPoint, CVector rightPoint) {
    plugin::Call<0x721DC0, unsigned int, unsigned char, unsigned char, unsigned char, uint8, CVector, CVector>(id, red, green, blue, alpha, leftPoint, rightPoint);
}
