...
#include "CWeapon.h"
#include "../Events_SA/Extender/VehicleExtender.h"
...
public:
	...
	{
		Lights.bHeadlight_Left = 0;
		Lights.bHeadlight_Right = 0;
		Lights.bIndicator_FrontLeft = 0;
		Lights.bIndicator_FrontRight = 0;
		Lights.bIndicator_RearLeft = 0;
		Lights.bIndicator_RearRight = 0;
		Lights.bTaillight_Left = 0;
		Lights.bTaillight_Right = 0;
		Lights.bReverselight_Left = 0;
