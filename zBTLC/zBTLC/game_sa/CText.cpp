...
tGXT_VERSION_2_TKEY_item* CText__TKey::bsearch(unsigned int key, tGXT_VERSION_2_TKEY_item *data, signed short firstIndex, short lastIndex)
{
	return ((tGXT_VERSION_2_TKEY_item* (__thiscall*)(CText__TKey*, unsigned int, tGXT_VERSION_2_TKEY_item *, signed short, short))FUNC_CText__TKey__Bsearch)(this, key, data, firstIndex, lastIndex);
}
