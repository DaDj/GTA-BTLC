...
public:
	...
	static void DoCollectableEffects(CObject* entity);
	static void DoMineEffects(CObject* entity);
	static void DoMoneyEffects(CObject* entity);
	static void DoPickUpEffects(CObject* entity);
