...
CMenuPanel* CMenuSystem::InputStandardMenu(unsigned char panelId)
{
	return ((CMenuPanel* (__cdecl *)(unsigned char))0x580800)(panelId);
}

CMenuPanel* CMenuSystem::InputGridMenu(unsigned char panelId)
{
	return ((CMenuPanel* (__cdecl *)(unsigned char))0x580BD0)(panelId);
}
...
CMenuPanel** CMenuSystem::InsertMenu(unsigned char panelId, unsigned char columnId, char *pTitle, char *str1, char *str2, char *str3, char *str4, char *str5, char *str6, char *str7, char *str8, char *str9, char *str10, char *str11, char *str12)
{
	return ((CMenuPanel** (__cdecl *)(unsigned char, unsigned char, char*, char*, char*, char*, char*, char*, char*, char*, char*, char*, char*, char*, char*))0x581E00)(panelId, columnId, pTitle, str1, str2, str3, str4, str5, str6, str7, str8, str9, str10, str11, str12);
}

CMenuPanel* CMenuSystem::InsertOneMenuItem(unsigned char panelId, unsigned char columnId, unsigned char rowId, char *str)
{
	return ((CMenuPanel* (__cdecl *)(unsigned char, unsigned char, unsigned char, char*))0x581CE0)(panelId, columnId, rowId, str);
}

CMenuPanel* CMenuSystem::InsertOneMenuItemWithNumber(unsigned char panelId, unsigned char columnId, unsigned char rowId, char *str, int number1, int number2)
{
	return ((CMenuPanel* (__cdecl *)(unsigned char, unsigned char, unsigned char, char*, int, int))0x581D70)(panelId, columnId, rowId, str, number1, number1);
}
